...
public class SubWriter extends QuesWriter{
	...
	public void Write(Ranking ranking){
		try(
			FileWriter fw = new FileWriter("makeQuestion\\引き算ランキング.csv",false); //true=追加/false=上書
	        ...
	        for(Record curr : records){
	        	line = "引き算"+","+rank+","+curr.getTime()+","+curr.getName()+",";
				pw.println(line);

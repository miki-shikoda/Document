...
public class DivWriter extends QuesWriter{
	...
	public void Write(Ranking ranking){
		try(
			FileWriter fw = new FileWriter("makeQuestion\\割り算ランキング.csv",false); //true=追加/false=上書
	        ...
	        for(Record curr : records){
	        	line = "割り算"+","+rank+","+curr.getTime()+","+curr.getName()+",";
				pw.println(line);
